    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-toggler">
          <ul class="navbar-nav">
             @auth()
              <li class="nav-item @if (request()->is('companies*'))
                active
              @endif"><a href="{{ route("companies.index") }}" class="nav-link">Companies</a></li>
              <li class="nav-item @if (request()->is('contacts*'))
                active
              @endif"><a href="{{ route("contacts.index") }}" class="nav-link">Contacts</a></li>
            @endauth
          </ul>
