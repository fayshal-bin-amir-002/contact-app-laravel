    ...
    <div class="col-md-6">
        <div class="row">
            <div class="col">
                ...
                |
                <a 
                    href="{{ request()->fullUrlWithQuery(["trash" => true]) }}" 
                    class="btn {{ request()->query("trash") ? "text-primary" : "text-secondary" }}">
                    Trash
                </a>
            </div>
    ...
    <form>
        ...
        <div class="row">
            ...
            <div class="input-group mb-3">
                <input type="text" name="search" value="{{ request()->query("search") }}" class="form-control" id="search-input" placeholder="Search..." aria-label="Search..." aria-describedby="button-addon2">
